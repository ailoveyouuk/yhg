  ...
  return (
    <footer className="bg-[#111110] text-white/50">
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-white/40">
              ...
              <p className="flex gap-3 items-center">
                ...
                <a href="tel:01604696225" className="hover:text-white transition-colors">01604 696225</a>
              </p>
              <p className="flex gap-3 items-center">
                <svg className="w-4 h-4 text-[#004225] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                </svg>
                <a href="mailto:admin@yardleyhastingsgarage.co.uk" className="hover:text-white transition-colors break-all">admin@yardleyhastingsgarage.co.uk</a>
              </p>
              <div className="pt-1">
                <table className="text-xs w-full">
                  <tbody>
                    <tr><td className="py-1 pr-6 text-white/25">Mon – Fri</td><td className="text-white/40">8:00am – 5:30pm</td></tr>
                    <tr><td className="py-1 pr-6 text-white/25">Saturday</td><td className="text-white/40">8:30am – 12 noon</td></tr>
                    <tr><td className="py-1 pr-6 text-white/25">Sunday</td><td className="text-white/20">Closed</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between text-xs text-white/20 gap-2">
