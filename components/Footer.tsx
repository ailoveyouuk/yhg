  ...
  return (
    <footer className="bg-[#111110] text-white/75">
            ...
            <div className="space-y-4 text-sm text-white/65">
              ...
              <div className="pt-1">
                <table className="text-xs w-full">
                  <tbody>
                    <tr><td className="py-1 pr-6 text-white/50">Mon – Fri</td><td className="text-white/65">8:00am – 5:30pm</td></tr>
                    <tr><td className="py-1 pr-6 text-white/50">Saturday</td><td className="text-white/65">8:30am – 12 noon</td></tr>
                    <tr><td className="py-1 pr-6 text-white/50">Sunday</td><td className="text-white/40">Closed</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between text-xs text-white/45 gap-2">
